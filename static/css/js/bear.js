...
function jsdbDown_360(id){
  window.location.href='https://downapi.bear20.com/down/s/hp'+id+'_48,34,17,9,2,0'
}
// 有9或48号包并且有10或4号包软件，360环境下金山毒霸取包方法
function jsdbDown_948(id){
  window.location.href='https://downapi.bear20.com/down/s/hp'+id+'_48,9,34,17,2,0'
}
// 360环境下AI浏览器取包方法
...
function TopDownLink(id){
  ...
  window.location.href='https://downapi.bear20.com/down/s/hp'+id+'_9,48,34,17,2,0'
}
// 微软安全管家下载
...
function bear_countone(mId,mf){
  var url = "https://more.yesky.com/soft/mdown.jsp?siteId=592342&id=" + mId + "&f=" + mf + "&fparam="+ fparam +"&rnd=" + Date.parse(new Date());
  $.getScript(url);
  console.log(mf);
...
function countone(referId,mf){
  var url = "https://more.yesky.com/soft/mdown.jsp?siteId=592342&id=" + referId + "&f="+mf+"&fparam="+ fparam +"&rnd=" + Date.parse(new Date());
  $.getScript(url);
}
// onebox在用统计方法代码
function oneboxCountone(mPlace,mId){
  var url = "https://more.yesky.com/soft/mdown.jsp?siteId=592342&t=rg&f="+encodeURI(mPlace)+"&id="+mId+"&fparam="+ fparam;
  $.getScript(url);
}
// 天极传媒首页软件下载方法
...
function tianjimedia_countone(mId,mf){
  var url = "https://more.yesky.com/soft/mdown.jsp?siteId=592733&id=" + mId + "&f=" + mf + "&fparam="+ fparam +"&rnd=" + Date.parse(new Date());
  $.getScript(url);
}
// 酷软在线首页软件下载方法
...
function sootool_countone(mId,mf){
  var url = "https://more.yesky.com/soft/mdown.jsp?siteId=592859&id=" + mId + "&f=" + mf + "&fparam="+ fparam +"&rnd=" + Date.parse(new Date());
  $.getScript(url);
}
// 天极传媒历史版本下载
...
function meedown_countone(mId,mf){
  var url = "https://more.yesky.com/soft/mdown.jsp?siteId=592892&id=" + mId + "&f=" + mf + "&fparam="+ fparam +"&rnd=" + Date.parse(new Date());
  $.getScript(url);
}
// 酷软在线-桌面软件 详情页软件下载
...
function kkdang_countone(mId,mf){
  var url = "https://more.yesky.com/soft/mdown.jsp?siteId=592893&id=" + mId + "&f=" + mf + "&fparam="+ fparam +"&rnd=" + Date.parse(new Date());
  $.getScript(url);
}
// 酷软在线-电脑软件历史版本下载
...
function kuaidown_countone(mId,mf){
  var url = "https://more.yesky.com/soft/mdown.jsp?siteId=593471&id=" + mId + "&f=" + mf + "&fparam="+ fparam +"&rnd=" + Date.parse(new Date());
  $.getScript(url);
}
// 酷软优选历史版本下载
...
function hoyodo_countone(mId,mf){
  var url = "https://more.yesky.com/soft/mdown.jsp?siteId=593542&id=" + mId + "&f=" + mf + "&fparam="+ fparam +"&rnd=" + Date.parse(new Date());
  $.getScript(url);
}
// 阔思亮下载站历史版本下载
